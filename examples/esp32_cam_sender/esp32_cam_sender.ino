...
// Configuracion por camara. Clonar este sketch y cambiar CAMERA_ID para cam2/cam3.
...
static const char* CAMERA_ID = "cam1";
static const char* CAMERA_TOKEN = "";

// Intervalo entre frames. Para snapshots, no streaming.
